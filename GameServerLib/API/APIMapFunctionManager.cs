...
namespace LeagueSandbox.GameServer.API
{
    public static class ApiMapFunctionManager
    {
        ...
        public static void EndGame(TeamId losingTeam, Vector3 finalCameraPosition, float endGameTimer = 5000.0f, bool moveCamera = true, float cameraTimer = 3.0f, bool disableUI = true, LeagueSandbox.GameServer.GameObjects.AttackableUnits.DeathData deathData = null)
        {
