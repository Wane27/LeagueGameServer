...
namespace PacketDefinitions420
{
    ...
    public class PacketNotifier
    {
        ...
        public void NotifyBuilding_Die(LeagueSandbox.GameServer.GameObjects.AttackableUnits.DeathData deathData)
        {
        ...
        public void NotifyDeath(LeagueSandbox.GameServer.GameObjects.AttackableUnits.DeathData deathData)
        {
        ...
        public void NotifyInhibitorState(Inhibitor inhibitor, LeagueSandbox.GameServer.GameObjects.AttackableUnits.DeathData deathData = null, List<Champion> assists = null)
        {
        ...
        public void NotifyNPC_Die_Broadcast(LeagueSandbox.GameServer.GameObjects.AttackableUnits.DeathData data)
        {
        ...
        public void NotifyNPC_Hero_Die(LeagueSandbox.GameServer.GameObjects.AttackableUnits.DeathData deathData)
        {
        ...
        public void NotifyS2C_Neutral_Camp_Empty(MonsterCamp monsterCamp, LeagueSandbox.GameServer.GameObjects.AttackableUnits.DeathData deathData = null, int userId = -1)
        {
        ...
        /// </summary>
        /// <param name="data">Data of the death.</param>
        public void NotifyS2C_NPC_Die_MapView(LeagueSandbox.GameServer.GameObjects.AttackableUnits.DeathData data)
        {
        ...
        void NotifyEnterTeamVision(GameObject obj, TeamId team, int userId = -1, GamePacket spawnPacket = null)
        {
            ...
            else //if(obj is Region || obj is SpellMissile || obj is ILevelProp || obj is Particle)
            {
