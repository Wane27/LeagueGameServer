namespace Buffs
{
    internal class BlessingoftheLizardElder : IBuffGameScript
    {
        ...
        public void OnActivate(AttackableUnit unit, Buff buff, Spell ownerSpell)
        {
            ...
            particle = unit is Champion champ
                ? AddParticleTarget(unit, unit, "NeutralMonster_buf_red_offense", unit, buff.Duration)
                : AddParticleTarget(unit, unit, "NeutralMonster_buf_red_offense_big", unit, buff.Duration);
